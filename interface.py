...
pygame.mixer.music.set_volume(0.5)  # Réglez le volume (facultatif)
pygame.mixer.music.play(-1)  # "-1" signifie que la musique se répétera en boucle

# Afficher un GIF au milieu
image = Image.open("votre_gif.gif")  # Remplacez "votre_gif.gif" par le chemin de votre GIF
